...
* `introductoryPrice` [ProductDiscount](/docs/latest/api/structures/product-discount) (optional) - The object containing introductory price information for the product.
