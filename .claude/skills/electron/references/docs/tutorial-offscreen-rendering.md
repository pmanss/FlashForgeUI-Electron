...
[Frameless Window](/docs/latest/tutorial/window-customization).
...
[`app.disableHardwareAcceleration()`](/docs/latest/api/app#appdisablehardwareacceleration) API.

## Example[â](#example "Direct link to Example")

[docs/fiddles/features/offscreen-rendering (40.0.0)](https://github.com/electron/electron/tree/v40.0.0/docs/fiddles/features/offscreen-rendering)[Open in Fiddle](https://fiddle.electronjs.org/launch?target=electron/v40.0.0/docs/fiddles/features/offscreen-rendering)
...
- [GPU accelerated](#gpu-accelerated)- [Software output device](#software-output-device)* [Example](#example)