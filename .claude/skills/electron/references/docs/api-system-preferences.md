...
See the [Windows docs](https://learn.microsoft.com/en-us/windows/win32/api/winuser/nf-winuser-getsyscolor) and the [macOS docs](https://developer.apple.com/design/human-interface-guidelines/macos/visual-design/color#dynamic-system-colors) for more details.
...
* [Events](#events)
+ [`'accent-color-changed'`](#event-accent-color-changed-windows-linux)+ [`'color-changed'`](#event-color-changed-windows)* [Methods](#methods)
+ [`isSwipeTrackingFromScrollEventsEnabled`](#systempreferencesisswipetrackingfromscrolleventsenabled-macos)+ [`postNotification`](#systempreferencespostnotificationevent-userinfo-deliverimmediately-macos)+ [`postLocalNotification`](#systempreferencespostlocalnotificationevent-userinfo-macos)+ [`postWorkspaceNotification`](#systempreferencespostworkspacenotificationevent-userinfo-macos)+ [`subscribeNotification`](#systempreferencessubscribenotificationevent-callback-macos)+ [`subscribeLocalNotification`](#systempreferencessubscribelocalnotificationevent-callback-macos)+ [`subscribeWorkspaceNotification`](#systempreferencessubscribeworkspacenotificationevent-callback-macos)+ [`unsubscribeNotification`](#systempreferencesunsubscribenotificationid-macos)+ [`unsubscribeLocalNotification`](#systempreferencesunsubscribelocalnotificationid-macos)+ [`unsubscribeWorkspaceNotification`](#systempreferencesunsubscribeworkspacenotificationid-macos)+ [`registerDefaults`](#systempreferencesregisterdefaultsdefaults-macos)+ [`getUserDefault`](#systempreferencesgetuserdefaulttype-extends-keyof-userdefaulttypeskey-type-macos)+ [`setUserDefault`](#systempreferencessetuserdefaulttype-extends-keyof-userdefaulttypeskey-type-value-macos)+ [`removeUserDefault`](#systempreferencesremoveuserdefaultkey-macos)+ [`getAccentColor`](#systempreferencesgetaccentcolor)+ [`getColor`](#systempreferencesgetcolorcolor-windows-macos)+ [`getSystemColor`](#systempreferencesgetsystemcolorcolor-macos)+ [`getEffectiveAppearance`](#systempreferencesgeteffectiveappearance-macos)+ [`canPromptTouchID`](#systempreferencescanprompttouchid-macos)+ [`promptTouchID`](#systempreferencesprompttouchidreason-macos)+ [`isTrustedAccessibilityClient`](#systempreferencesistrustedaccessibilityclientprompt-macos)+ [`getMediaAccessStatus`](#systempreferencesgetmediaaccessstatusmediatype-windows-macos)+ [`askForMediaAccess`](#systempreferencesaskformediaaccessmediatype-macos)+ [`getAnimationSettings`](#systempreferencesgetanimationsettings)* [Properties](#properties)
+ [`accessibilityDisplayShouldReduceTransparency`](#systempreferencesaccessibilitydisplayshouldreducetransparency-macos-deprecated)+ [`effectiveAppearance`](#systempreferenceseffectiveappearance-macos-readonly)