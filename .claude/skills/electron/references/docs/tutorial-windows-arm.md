...
* [Running a basic app](#running-a-basic-app)* [General considerations](#general-considerations)
+ [Architecture-specific code](#architecture-specific-code)+ [Native modules](#native-modules)+ [Testing your app](#testing-your-app)* [Development prerequisites](#development-prerequisites)
+ [Node.js/node-gyp](#nodejsnode-gyp)+ [Visual Studio 2017](#visual-studio-2017)
- [Creating a cross-compilation command prompt](#creating-a-cross-compilation-command-prompt)+ [Linking against the correct `node.lib`](#linking-against-the-correct-nodelib)* [Cross-compiling native modules](#cross-compiling-native-modules)* [Debugging native modules](#debugging-native-modules)* [Getting additional help](#getting-additional-help)