...
* [Methods](#methods)
+ [`isEncryptionAvailable`](#safestorageisencryptionavailable)+ [`encryptString`](#safestorageencryptstringplaintext)+ [`decryptString`](#safestoragedecryptstringencrypted)+ [`setUsePlainTextEncryption`](#safestoragesetuseplaintextencryptionuseplaintext)+ [`getSelectedStorageBackend`](#safestoragegetselectedstoragebackend-linux)