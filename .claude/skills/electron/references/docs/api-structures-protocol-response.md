...
[net error list](https://source.chromium.org/chromium/chromium/src/+/main:net/base/net_error_list.h).
...
* `uploadData` [ProtocolResponseUploadData](/docs/latest/api/structures/protocol-response-upload-data) (optional) - The data used as upload data. This is only
