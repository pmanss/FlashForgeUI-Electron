...
- [`'changed'`](#event-changed)+ [Instance Methods](#instance-methods)
- [`get`](#cookiesgetfilter)- [`set`](#cookiessetdetails)- [`remove`](#cookiesremoveurl-name)- [`flushStore`](#cookiesflushstore)