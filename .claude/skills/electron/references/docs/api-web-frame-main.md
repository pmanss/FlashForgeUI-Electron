...
[`WebContents`](/docs/latest/api/web-contents) instances. Navigation events are the common
use case.
...
of [`WebContents`](/docs/latest/api/web-contents).
...
[`webFrame.frameToken`](/docs/latest/api/web-frame#webframeframetoken-readonly).
...
[`WebContents.ipc`](/docs/latest/api/web-contents#contentsipc-readonly) interface may be more
...
process. This is equivalent to [`webFrame.frameToken`](/docs/latest/api/web-frame#webframeframetoken-readonly).
...
while the corresponding page is running any [unload](https://developer.mozilla.org/en-US/docs/Web/API/Window/unload_event) listeners, it may become detached as the
newly navigated page replaced it in the frame tree.

* [Methods](#methods)
+ [`fromId`](#webframemainfromidprocessid-routingid)+ [`fromFrameToken`](#webframemainfromframetokenprocessid-frametoken)* [Class: WebFrameMain](#class-webframemain)
+ [Instance Events](#instance-events)
- [`'dom-ready'`](#event-dom-ready)+ [Instance Methods](#instance-methods)
- [`executeJavaScript`](#frameexecutejavascriptcode-usergesture)- [`reload`](#framereload)- [`isDestroyed`](#frameisdestroyed)- [`send`](#framesendchannel-args)- [`postMessage`](#framepostmessagechannel-message-transfer)- [`collectJavaScriptCallStack`](#framecollectjavascriptcallstack-experimental)+ [Instance Properties](#instance-properties)
- [`ipc`](#frameipc-readonly)- [`url`](#frameurl-readonly)- [`origin`](#frameorigin-readonly)- [`top`](#frametop-readonly)- [`parent`](#frameparent-readonly)- [`frames`](#frameframes-readonly)- [`framesInSubtree`](#frameframesinsubtree-readonly)- [`frameTreeNodeId`](#frameframetreenodeid-readonly)- [`name`](#framename-readonly)- [`frameToken`](#frameframetoken-readonly)- [`osProcessId`](#frameosprocessid-readonly)- [`processId`](#frameprocessid-readonly)- [`routingId`](#frameroutingid-readonly)- [`visibilityState`](#framevisibilitystate-readonly)- [`detached`](#framedetached-readonly)