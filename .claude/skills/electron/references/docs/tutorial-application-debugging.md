...
Google offers [excellent documentation for their developer tools](https://developer.chrome.com/devtools).
...
[be used to debug Electron's main process](https://nodejs.org/en/docs/inspector/) thanks to a closer collaboration
...
* [Renderer Process](#renderer-process)* [Main Process](#main-process)* [V8 Crashes](#v8-crashes)