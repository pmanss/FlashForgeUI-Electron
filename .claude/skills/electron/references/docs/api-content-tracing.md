...
[trace viewer](https://chromium.googlesource.com/catapult/+/HEAD/tracing/README.md), available at `chrome://tracing` in Chrome.
...
* [Methods](#methods)
+ [`getCategories`](#contenttracinggetcategories)+ [`startRecording`](#contenttracingstartrecordingoptions)+ [`stopRecording`](#contenttracingstoprecordingresultfilepath)+ [`getTraceBufferUsage`](#contenttracinggettracebufferusage)