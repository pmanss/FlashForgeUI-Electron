...
- [`'data'`](#event-data)- [`'end'`](#event-end)- [`'aborted'`](#event-aborted)- [`'error'`](#event-error)+ [Instance Properties](#instance-properties)
- [`statusCode`](#responsestatuscode)- [`statusMessage`](#responsestatusmessage)- [`headers`](#responseheaders)- [`httpVersion`](#responsehttpversion)- [`httpVersionMajor`](#responsehttpversionmajor)- [`httpVersionMinor`](#responsehttpversionminor)- [`rawHeaders`](#responserawheaders)