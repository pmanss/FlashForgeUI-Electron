...
collection of the official Electron tools, using [`@electron/packager`](https://github.com/electron/packager),
[`@electron/osx-sign`](https://github.com/electron/osx-sign), and [`@electron/notarize`](https://github.com/electron/notarize) under the hood.
...
are likely using [`@electron/packager`](https://github.com/electron/packager), which includes [`@electron/osx-sign`](https://github.com/electron/osx-sign) and
...
If the example below does not meet your needs, please see [`@electron/osx-sign`](https://github.com/electron/osx-sign) and
[`@electron/notarize`](https://github.com/electron/notarize) for the many possible configuration options.
...
All tools in the Electron ecosystem use [`@electron/windows-sign`](https://github.com/electron/windows-sign) and typically
...
Forge, [`@electron/packager`](https://github.com/electron/packager), [`electron-winstaller`](https://github.com/electron/windows-installer), and [`electron-wix-msi`](https://github.com/electron-userland/electron-wix-msi).
...
If you're not using an integrated build pipeline like Forge, you
are likely using [`@electron/packager`](https://github.com/electron/packager), which includes [`@electron/windows-sign`](https://github.com/electron/windows-sign).

If you're using Packager's API, you can pass
[in configuration that signs your application](https://electron.github.io/packager/main/modules.html).
If the example below does not meet your needs, please see [`@electron/windows-sign`](https://github.com/electron/windows-sign)
...
[`electron-winstaller`](https://github.com/electron/windows-installer) is a package that can generate Squirrel.Windows installers for your
Electron app. This is the tool used under the hood by Electron Forge's
[Squirrel.Windows Maker](https://www.electronforge.io/config/makers/squirrel.windows). Just like `@electron/packager`, it uses
[`@electron/windows-sign`](https://github.com/electron/windows-sign) under the hood and supports the same `windowsSign`
options.
...
[`electron-wix-msi`](https://github.com/electron-userland/electron-wix-msi) is a package that can generate MSI installers for your
Electron app. This is the tool used under the hood by Electron Forge's [MSI Maker](https://www.electronforge.io/config/makers/wix-msi).
Just like `@electron/packager`, it uses [`@electron/windows-sign`](https://github.com/electron/windows-sign) under the hood
...
[Azure Trusted Signing](https://azure.microsoft.com/en-us/products/trusted-signing) is Microsoft's modern cloud-based alternative to EV certificates.
...
[here](https://www.electronforge.io/guides/code-signing/code-signing-windows#using-azure-trusted-signing).
...
[here](https://www.electron.build/code-signing-win#using-azure-trusted-signing-beta).
...
+ [Using Electron Forge](#using-electron-forge)+ [Using Electron Packager](#using-electron-packager)+ [Signing Mac App Store applications](#signing-mac-app-store-applications)* [Signing Windows builds](#signing-windows-builds)
+ [Using traditional certificates](#using-traditional-certificates)
- [Using Electron Forge](#using-electron-forge-1)- [Using Electron Packager](#using-electron-packager-1)- [Using electron-winstaller (Squirrel.Windows)](#using-electron-winstaller-squirrelwindows)- [Using electron-wix-msi (WiX MSI)](#using-electron-wix-msi-wix-msi)- [Using Electron Builder](#using-electron-builder)+ [Using Azure Trusted Signing](#using-azure-trusted-signing)
- [Using Electron Forge](#using-electron-forge-2)- [Using Electron Builder](#using-electron-builder-1)+ [Signing Windows Store applications](#signing-windows-store-applications)