...
with the request.
+ `session` Session (optional) - The [`Session`](/docs/latest/api/session) instance with
which the request is associated.
+ `partition` string (optional) - The name of the [`partition`](/docs/latest/api/session)
...
handler. [webRequest](/docs/latest/api/web-request) handlers will still be triggered
...
+ [`new ClientRequest(options)`](#new-clientrequestoptions)+ [Instance Events](#instance-events)
- [`'response'`](#event-response)- [`'login'`](#event-login)- [`'finish'`](#event-finish)- [`'abort'`](#event-abort)- [`'error'`](#event-error)- [`'close'`](#event-close)- [`'redirect'`](#event-redirect)+ [Instance Properties](#instance-properties)
- [`chunkedEncoding`](#requestchunkedencoding)+ [Instance Methods](#instance-methods)
- [`setHeader`](#requestsetheadername-value)- [`getHeader`](#requestgetheadername)- [`removeHeader`](#requestremoveheadername)- [`write`](#requestwritechunk-encoding-callback)- [`end`](#requestendchunk-encoding-callback)- [`abort`](#requestabort)- [`followRedirect`](#requestfollowredirect)- [`getUploadProgress`](#requestgetuploadprogress)