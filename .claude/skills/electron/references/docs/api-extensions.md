...
Electron supports a subset of the [Chrome Extensions API](https://developer.chrome.com/extensions/api_index),
...
[`ses.extensions.loadExtension`](/docs/latest/api/extensions-api#extensionsloadextensionpath-options):
...
See the [`session`](/docs/latest/api/session) documentation for more information about
...
* [Loading extensions](#loading-extensions)* [Supported Extensions APIs](#supported-extensions-apis)
+ [Supported Manifest Keys](#supported-manifest-keys)+ [`devtools.inspectedWindow`](#chromedevtoolsinspectedwindow)+ [`devtools.network`](#chromedevtoolsnetwork)+ [`devtools.panels`](#chromedevtoolspanels)+ [`extension`](#chromeextension)+ [`management`](#chromemanagement)+ [`runtime`](#chromeruntime)+ [`scripting`](#chromescripting)+ [`storage`](#chromestorage)+ [`tabs`](#chrometabs)+ [`webRequest`](#chromewebrequest)