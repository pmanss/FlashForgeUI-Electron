...
Electron supports [Chrome DevTools extensions](https://developer.chrome.com/docs/extensions/how-to/devtools/extend-devtools), which can
...
process for you. [electron-devtools-installer](https://github.com/MarshallOfSound/electron-devtools-installer) is a popular
...
locate its filesystem path, and then load it into your [Session](/docs/latest/api/session) by calling the
[`ses.loadExtension`](/docs/latest/api/extensions-api#extensionsloadextensionpath-options) API.
...
4. Pass the location of the extension to the [`ses.loadExtension`](/docs/latest/api/extensions-api#extensionsloadextensionpath-options)
...
* `loadExtension` returns a Promise with an [Extension object](/docs/latest/api/structures/extension),
...
You can pass the extension's ID to the [`ses.removeExtension`](/docs/latest/api/extensions-api#extensionsremoveextensionextensionid) API to
...
[a limited set of `chrome.*` APIs](/docs/latest/api/extensions),
...
[issue tracker](https://github.com/electron/electron/issues) and describe which part
of the extension is not working as expected.

* [Loading a DevTools extension with tooling](#loading-a-devtools-extension-with-tooling)* [Manually loading a DevTools extension](#manually-loading-a-devtools-extension)
+ [Removing a DevTools extension](#removing-a-devtools-extension)* [DevTools extension support](#devtools-extension-support)
