...
ASAR stands for Atom Shell Archive Format. An [asar](https://github.com/electron/asar) archive is a simple
...
MAS, see the [Mac App Store Submission Guide](/docs/latest/tutorial/mac-app-store-submission-guide).
...
Native modules (also called [addons](https://nodejs.org/api/addons.html) in
...
apps that make use of the [main](#main-process) and one or many [renderer](#renderer-process) process are
...
automatically as new versions are released. See the [autoUpdater](/docs/latest/api/auto-updater) API for
...
In Electron, you can create this process using [UtilityProcess](/docs/latest/api/utility-process) API.
...
* [ASAR](#asar)* [ASAR integrity](#asar-integrity)* [code signing](#code-signing)* [context isolation](#context-isolation)* [CRT](#crt)* [DMG](#dmg)* [IME](#ime)* [IDL](#idl)* [IPC](#ipc)* [main process](#main-process)* [MAS](#mas)* [Mojo](#mojo)* [MSI](#msi)* [native modules](#native-modules)* [notarization](#notarization)* [OSR](#osr)* [preload script](#preload-script)* [process](#process)* [renderer process](#renderer-process)* [sandbox](#sandbox)* [Squirrel](#squirrel)* [userland](#userland)* [utility process](#utility-process)* [V8](#v8)* [webview](#webview)