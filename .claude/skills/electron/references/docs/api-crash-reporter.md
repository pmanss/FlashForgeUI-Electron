...
Returns [CrashReport | null](/docs/latest/api/structures/crash-report) - The date and ID of the
...
* [Methods](#methods)
+ [`start`](#crashreporterstartoptions)+ [`getLastCrashReport`](#crashreportergetlastcrashreport)+ [`getUploadedReports`](#crashreportergetuploadedreports)+ [`getUploadToServer`](#crashreportergetuploadtoserver)+ [`setUploadToServer`](#crashreportersetuploadtoserveruploadtoserver)+ [`addExtraParameter`](#crashreporteraddextraparameterkey-value)+ [`removeExtraParameter`](#crashreporterremoveextraparameterkey)+ [`getParameters`](#crashreportergetparameters)* [In Node child processes](#in-node-child-processes)
+ [`crashReporter.start`](#processcrashreporterstartoptions)+ [`crashReporter.getParameters`](#processcrashreportergetparameters)+ [`crashReporter.addExtraParameter`](#processcrashreporteraddextraparameterkey-value)+ [`crashReporter.removeExtraParameter`](#processcrashreporterremoveextraparameterkey)* [Crash Report Payload](#crash-report-payload)