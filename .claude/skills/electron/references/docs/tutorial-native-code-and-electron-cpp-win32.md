...
+ [Microsoft Visual Studio Build Configurations](#microsoft-visual-studio-build-configurations)
- [`VCCLCompilerTool` Settings](#vcclcompilertool-settings)- [`VCLinkerTool` Settings](#vclinkertool-settings)+ [Preprocessor macros (`defines`):](#preprocessor-macros-defines)* [3) Defining the C++ Interface](#3-defining-the-c-interface)* [4) Implementing Win32 GUI Code](#4-implementing-win32-gui-code)* [5) Creating the Node.js Addon Bridge](#5-creating-the-nodejs-addon-bridge)
+ [Create a Class to Wrap Our C++ Code](#create-a-class-to-wrap-our-c-code)+ [Implement Basic Functionality - HelloWorld](#implement-basic-functionality---helloworld)+ [Setting Up the Event System](#setting-up-the-event-system)+ [Putting the bridge together](#putting-the-bridge-together)* [6) Creating a JavaScript Wrapper](#6-creating-a-javascript-wrapper)* [7) Building and Testing the Addon](#7-building-and-testing-the-addon)* [Conclusion](#conclusion)