...
* [Events](#events)
+ [`'updated'`](#event-updated)* [Properties](#properties)
+ [`shouldUseDarkColors`](#nativethemeshouldusedarkcolors-readonly)+ [`themeSource`](#nativethemethemesource)+ [`shouldUseHighContrastColors`](#nativethemeshouldusehighcontrastcolors-macos-windows-readonly)+ [`shouldUseDarkColorsForSystemIntegratedUI`](#nativethemeshouldusedarkcolorsforsystemintegratedui-macos-windows-readonly)+ [`shouldUseInvertedColorScheme`](#nativethemeshoulduseinvertedcolorscheme-macos-windows-readonly)+ [`inForcedColorsMode`](#nativethemeinforcedcolorsmode-windows-readonly)+ [`prefersReducedTransparency`](#nativethemeprefersreducedtransparency-readonly)