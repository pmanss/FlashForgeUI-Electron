...
+ [`new TouchBarSegmentedControl(options)`](#new-touchbarsegmentedcontroloptions)+ [Instance Properties](#instance-properties)
- [`segmentStyle`](#touchbarsegmentedcontrolsegmentstyle)- [`segments`](#touchbarsegmentedcontrolsegments)- [`selectedIndex`](#touchbarsegmentedcontrolselectedindex)- [`mode`](#touchbarsegmentedcontrolmode)