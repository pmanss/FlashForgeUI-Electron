...
* [Requirements](#requirements)* [1) Creating a package](#1-creating-a-package)* [2) Setting up the build configuration](#2-setting-up-the-build-configuration)* [3) Defining the C++ interface](#3-defining-the-c-interface)* [4) Implementing GTK3 GUI Code](#4-implementing-gtk3-gui-code)
+ [Basic Setup and Data Structures](#basic-setup-and-data-structures)+ [Global state and forward declarations](#global-state-and-forward-declarations)+ [Helper Functions](#helper-functions)+ [Event handlers](#event-handlers)+ [GTK application setup](#gtk-application-setup)+ [Main GUI function and thread management](#main-gui-function-and-thread-management)+ [Callback management](#callback-management)+ [Putting `cpp_code.cc` together](#putting-cpp_codecc-together)* [5) Creating the Node.js addon bridge](#5-creating-the-nodejs-addon-bridge)
+ [Create a class to wrap our C++ code](#create-a-class-to-wrap-our-c-code)+ [Implement basic functionality - HelloWorld](#implement-basic-functionality---helloworld)+ [Setting up the event system](#setting-up-the-event-system)+ [Putting `cpp_addon.cc` together](#putting-cpp_addoncc-together)* [6) Creating a JavaScript wrapper](#6-creating-a-javascript-wrapper)* [7) Building and testing the addon](#7-building-and-testing-the-addon)* [Usage Example](#usage-example)* [Conclusion](#conclusion)