...
* [Methods](#methods)
+ [`register`](#globalshortcutregisteraccelerator-callback)+ [`registerAll`](#globalshortcutregisterallaccelerators-callback)+ [`isRegistered`](#globalshortcutisregisteredaccelerator)+ [`unregister`](#globalshortcutunregisteraccelerator)+ [`unregisterAll`](#globalshortcutunregisterall)