...
only run under [App Sandbox](https://developer.apple.com/documentation/security/app_sandbox), so they must use the MAS build of
...
[App Sandbox](https://developer.apple.com/documentation/security/app_sandbox), and only the MAS build of Electron can run with
...
still need to read Apple's [Submitting Your App](https://help.apple.com/xcode/mac/current/#/dev067853c94) guide on
how to meet the Mac App Store requirements.

### Upload[â](#upload "Direct link to Upload")

[Apple Transporter](https://help.apple.com/itc/transporteruserguide/en.lproj/static.html) should be used to upload the signed app to App Store
Connect for processing, making sure you have [created a record](https://developer.apple.com/help/app-store-connect/create-an-app-record/add-a-new-app)
before uploading.
...
the app are strictly limited; you can read [App Sandboxing](https://developer.apple.com/documentation/security/app_sandbox) for
more information.
...
A full list of entitlements is available in the [App Sandbox](https://developer.apple.com/documentation/security/app_sandbox)
...
See the [Enabling Network Access documentation](https://developer.apple.com/library/ios/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW9) for more
details.
...
See the [Enabling User-Selected File Access documentation](https://developer.apple.com/library/mac/documentation/Miscellaneous/Reference/EntitlementKeyReference/Chapters/EnablingAppSandbox.html#//apple_ref/doc/uid/TP40011195-CH4-SW6) for
more details.
...
software. See the [encryption export compliance docs](https://help.apple.com/app-store-connect/#/devc3f64248f) for
more information.
...
* [Requirements](#requirements)* [Sign Electron apps](#sign-electron-apps)
+ [Get certificates](#get-certificates)
- [Other certificates](#other-certificates)- [Legacy certificate names](#legacy-certificate-names)+ [Prepare provisioning profile](#prepare-provisioning-profile)+ [Enable Apple's App Sandbox](#enable-apples-app-sandbox)+ [Sign apps for development](#sign-apps-for-development)+ [Sign apps for submitting to the Mac App Store](#sign-apps-for-submitting-to-the-mac-app-store)* [Submit apps to the Mac App Store](#submit-apps-to-the-mac-app-store)
+ [Upload](#upload)+ [Submit for review](#submit-for-review)* [Limitations of MAS Build](#limitations-of-mas-build)
+ [Additional entitlements](#additional-entitlements)
- [Network access](#network-access)- [dialog.showOpenDialog](#dialogshowopendialog)- [dialog.showSaveDialog](#dialogshowsavedialog)* [Cryptographic Algorithms Used by Electron](#cryptographic-algorithms-used-by-electron)