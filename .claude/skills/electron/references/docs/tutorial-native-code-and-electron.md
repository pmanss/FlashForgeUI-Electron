...
+ [Requirements: macOS](#requirements-macos)+ [Requirements: Windows](#requirements-windows)+ [Requirements: Linux](#requirements-linux)* [1) Creating a package](#1-creating-a-package)* [2) Setting up the build system](#2-setting-up-the-build-system)
+ [Configuring `node-gyp`](#configuring-node-gyp)* [3) "Hello World" from C++](#3-hello-world-from-c)
+ [Building and testing the addon](#building-and-testing-the-addon)+ [Using the addon in Electron](#using-the-addon-in-electron)* [References and further learning](#references-and-further-learning)