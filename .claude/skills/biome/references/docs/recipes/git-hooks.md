...
In contrast to other tools such as *lefthook*, *pre-commit*, and *lint-staged*,
...
See the [comparison of *git-format-staged* with other tools](https://github.com/hallettj/git-format-staged#comparisons-to-similar-utilities).
